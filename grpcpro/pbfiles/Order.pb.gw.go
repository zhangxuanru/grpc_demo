...
var (
	pattern_OrderService_NewOrder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "orderNew"}, "", runtime.AssumeColonVerbOpt(true)))
)
